...
/*   Updated: 2025/05/24 13:38:39 by lihrig           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void print_completion_message(t_data *data)
{
    ...
    current_time = get_current_time();
    elapsed_time = current_time - data->start_time;
    printf("%ld All philosophers have eaten %d times each. Simulation complete!\n",
 ...
 * Returns 1 if simulation should end due to completion, 0 if it should continue.
